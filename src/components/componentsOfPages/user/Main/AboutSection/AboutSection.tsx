        ...
        <>
            <section id="aboutSection" className="pt-[130px] T:pt-[100px] TS:pt-[70px] px-[12%] L:px-[20px] P:px-[10px] relative flex flex-row gap-[75px]">
                ...
                <div className="relative w-1/2 T:hidden">
                    <img src={cake_about} alt="cake_about" className='relative w-full z-30' loading="lazy" />
                    <svg className="absolute z-20 -top-36 right-0 w-[700px] h-[700px] opacity-70" viewBox="0 0 697 700" fill="none" xmlns="http://www.w3.org/2000/svg">
