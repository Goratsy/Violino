        ...
        <>
            <section id="aboutSection" className="pt-[130px] T:pt-[100px] TS:pt-[70px] px-[12%] L:px-[20px] P:px-[10px] relative flex flex-row gap-[75px]">
                <div className="w-1/2 T:w-full ">
                    <img src={cake_about_small} alt="cake_about_small" className='w-full z-10 animate-fade animate-duration-500 animate-ease-in-out animate-delay-[200ms]' loading="lazy" />
                    <div className="relative mt-[30px]">
                        <div className="animate-fade-left animate-duration-600 animate-ease-out animate-delay-[200ms]">
                            <HeadingOfSection>О нас</HeadingOfSection>
                        </div>
                        <div className="mt-[4px] animate-fade-left animate-duration-600 animate-ease-out animate-delay-[300ms]">
                            <H2 align="text-left T:hidden">История<br /> нашего пути</H2>
                            <H2 align="text-left hidden T:block">Наша история</H2>
                        </div>
                        <div className="pl-[40px] mt-[18px] T:mt-[12px] T:pl-[30px] P:mt-[8px] P:pl-[20px] T:w-2/3 TS:w-5/6 P:w-11/12 ">
                            <div className="mb-[40px] T:mb-[30px] P:mb-[20px] animate-fade-left animate-duration-600 animate-ease-out animate-delay-[400ms]">
                            ...
                            <div className="w-[164px] P:w-[120px] animate-fade-left animate-duration-600 animate-ease-out animate-delay-[500ms]">
                ...
                <div className="relative w-1/2 T:hidden">
                    <img src={cake_about} alt="cake_about" className='relative w-full z-30 animate-fade animate-duration-500 animate-ease-in-out animate-delay-[300ms]' loading="lazy" />
                    <svg className="absolute z-20 -top-36 right-0 w-[700px] h-[700px] opacity-70 animate-fade-down animate-duration-[600ms] animate-delay-100 animate-ease-in-out" viewBox="0 0 697 700" fill="none" xmlns="http://www.w3.org/2000/svg">
