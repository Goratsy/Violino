        ...
        <>
            <section id="aboutSection" className="mt-[130px] T:mt-[100px] TS:mt-[70px] px-[12%] L:px-[20px] P:px-[10px] relative flex flex-row gap-[75px]">
                ...
                <div className="relative w-1/2 T:hidden">
                    <AnimatedElementFade animateFade="animate-fade" additionalClasses="relative w-full z-30">
                        <img src={cake_about} alt="cake_about" loading="lazy" />
                    </AnimatedElementFade>
                    <AnimatedElementFade threshold={0.5} animateFade="animate-fade" additionalClasses="absolute z-20 -top-36 right-0 w-[700px] h-[700px]">
