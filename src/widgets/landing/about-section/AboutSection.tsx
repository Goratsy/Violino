...
const cakeAboutSmall = '/assets/webp/cake_about_small.webp';
const cakeAbout = '/assets/webp/cake_about.webp';
    ...
    return (
        <>
            <section id="aboutSection" className="relative pt-[130px] T:pt-[100px] TS:pt-[70px] px-[12%] L:px-[20px] P:px-[10px] flex flex-row gap-[75px]">
                <div className="relative w-1/2 T:w-full">
                    <AnimatedElementFade animateFade="animate-fade"  delay="animate-delay-[300ms]">
                        <img src={cakeAboutSmall} alt="cake_about_small" className='w-full z-10' loading="lazy" />
                    </AnimatedElementFade>
                    <div className="relative mt-[30px]">
                        <AnimatedElementFade animateFade="animate-fade"  delay="animate-delay-[200ms]">
                            <HeadingOfSection>О нас</HeadingOfSection>
                        </AnimatedElementFade>
                        <AnimatedElementFade animateFade="animate-fade-left"  delay="animate-delay-[100ms]">
                ...
                <div className="relative w-1/2 T:hidden">
                    <AnimatedElementFade animateFade="animate-fade" additionalClasses="relative w-full z-30" delay="animate-delay-[100ms]">
                        <img src={cakeAbout} alt="cake_about" />
                    </AnimatedElementFade>
                    <AnimatedElementFade threshold={0.5} animateFade="animate-fade" additionalClasses="absolute z-20 -top-36 right-0 w-[700px] h-[700px]" delay="animate-delay-[100ms]">
                        <svg className="opacity-70" viewBox="0 0 697 700" fill="none" xmlns="http://www.w3.org/2000/svg">
