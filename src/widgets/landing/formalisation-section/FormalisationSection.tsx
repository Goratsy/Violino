...
const FormalisationSection: FC = () => {
    const cakeFormalisationDecor1Jpg = '/assets/webp/formalisationSection/decor/photo_decor_1.webp';
    const cakeFormalisationDecor2Jpg = '/assets/webp/formalisationSection/decor/photo_decor_2.webp';
    const cakeFormalisationDecor3Jpg = '/assets/webp/formalisationSection/decor/photo_decor_3.webp';
    const cakeFormalisationDecor4Jpg = '/assets/webp/formalisationSection/decor/photo_decor_4.webp';

    const cakeFormalisationDesert1Jpg = '/assets/webp/formalisationSection/deserts/photo_desert_1.webp';
    const cakeFormalisationDesert2Jpg = '/assets/webp/formalisationSection/deserts/photo_desert_2.webp';
    const cakeFormalisationDesert3Jpg = '/assets/webp/formalisationSection/deserts/photo_desert_3.webp';
    const cakeFormalisationDesert4Jpg = '/assets/webp/formalisationSection/deserts/photo_desert_4.webp';

    const cakeFormalisationForm1Jpg = '/assets/webp/formalisationSection/formation/photo_form_1.webp';
    const cakeFormalisationForm2Jpg = '/assets/webp/formalisationSection/formation/photo_form_2.webp';
    const cakeFormalisationForm3Jpg = '/assets/webp/formalisationSection/formation/photo_form_3.webp';
    const cakeFormalisationForm4Jpg = '/assets/webp/formalisationSection/formation/photo_form_4.webp';

    const cakeFormalisationFilling1Webp = '/assets/webp/formalisationSection/filling/filling_1.webp';
    const cakeFormalisationFilling2Webp = '/assets/webp/formalisationSection/filling/filling_2.webp';
    const cakeFormalisationFilling3Webp = '/assets/webp/formalisationSection/filling/filling_3.webp';
    const cakeFormalisationFilling4Webp = '/assets/webp/formalisationSection/filling/filling_4.webp';
    const cakeFormalisationFilling5Webp = '/assets/webp/formalisationSection/filling/filling_5.webp';
    const cakeFormalisationFilling6Webp = '/assets/webp/formalisationSection/filling/filling_6.webp';
    const cakeFormalisationFilling7Webp = '/assets/webp/formalisationSection/filling/filling_7.webp';
    const cakeFormalisationFilling8Webp = '/assets/webp/formalisationSection/filling/filling_8.webp';
    const cakeFormalisationFilling9Webp = '/assets/webp/formalisationSection/filling/filling_9.webp';
    const cakeFormalisationFilling10Webp = '/assets/webp/formalisationSection/filling/filling_10.webp';
    const cakeFormalisationFilling11Webp = '/assets/webp/formalisationSection/filling/filling_11.webp';
    const cakeFormalisationFilling12Webp = '/assets/webp/formalisationSection/filling/filling_12.webp';
    ...
    const imagesFilling = [[{ image: cakeFormalisationFilling1Webp, text: 'Фисташка с малиной' }, { image: cakeFormalisationFilling2Webp, text: 'Кокосовая' }, { image: cakeFormalisationFilling3Webp, text: 'Эстерхайзи' }],
    [{ image: cakeFormalisationFilling4Webp, text: 'Медовик' }, { image: cakeFormalisationFilling5Webp, text: 'Муссовая' }, { image: cakeFormalisationFilling6Webp, text: 'Красный бархат' }],
    [{ image: cakeFormalisationFilling7Webp, text: 'Фундук с грушей' }, { image: cakeFormalisationFilling8Webp, text: 'Сникерс' }, { image: cakeFormalisationFilling9Webp, text: 'Морковная' }],
    [{ image: cakeFormalisationFilling10Webp, text: 'Морковная с черносливом' }, { image: cakeFormalisationFilling11Webp, text: 'Три шоколада' }, { image: cakeFormalisationFilling12Webp, text: 'Шоколадная' }]];
                        ...
                        {'decor' === formalisation ?
                            <>
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[100ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDecor2Jpg} alt="cake_formalisation_decor_1_JPG" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[200ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDecor1Jpg} alt="cake_formalisation_decor_2_JPG" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[300ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDecor3Jpg} alt="cake_formalisation_decor_3_JPG" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[400ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDecor4Jpg} alt="cake_formalisation_decor_4_JPG" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                            </>
                            : ''
                        }
                        {'stylisation' === formalisation ?
                            <>
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[100ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationForm1Jpg} alt="cake_formalisation_1" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[200ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationForm2Jpg} alt="cake_formalisation_2" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[300ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationForm3Jpg} alt="cake_formalisation_3" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[400ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationForm4Jpg} alt="cake_formalisation_4" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                            </>
                            : ''
                        }
                        {'deserts' === formalisation ?
                            <>
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[100ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDesert1Jpg} alt="cake_formalisation_1" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[200ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDesert2Jpg} alt="cake_formalisation_2" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[300ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDesert3Jpg} alt="cake_formalisation_3" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                                ...
                                <AnimatedElementFade animateFade="animate-fade" delay='animate-delay-[400ms]' threshold={0.3} additionalClasses="relative">
                                    ...
                                    <img src={cakeFormalisationDesert4Jpg} alt="cake_formalisation_4" loading="lazy" className="w-full h-auto" />
                                </AnimatedElementFade>
                            </>
                            : ''
                        }
